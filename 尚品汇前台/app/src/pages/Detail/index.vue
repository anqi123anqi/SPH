                ...
                <div class="InfoWrap">
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="supSaleAttr in spuSaleAttrList" :key="supSaleAttr.id">
                                ...
                                <dd changepirce="0" :class="{active:spuSaleAttrValue.isChecked==1}"
                                    ...
                                    @click="changeActive(spuSaleAttrValue,supSaleAttr.spuSaleAttrValueList)">
                        ...
                        <div class="cartWrap">
                            ...
                            <div class="add">
                                <!-- 以前路由跳转，从A路由到B路由，这里是：加入购物车，进行路由跳转之前，发送请求获取你所购买的产品信息给服务器，服务器进行存储 -->
...
<script>
    ...
    export default {
        ...
        methods: {
            changeActive (slaeAttValue, arr) {
                //遍历全部的售卖属性值ischeck为0
                arr.forEach(item => {
                    item.isChecked = 0;
                });
                //所点击的属性值
                slaeAttValue.isChecked = 1;
            },
            changeSkuNum (e) {
            ...
            async addShopcar () {
                //1.发送请求:将产品加入到数据库 
                //async:async函数执行返回的结果是一个promise（要么成功要么失败）
                try {
