<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearfix" v-for="(addres,index) in address" :key=index>
        ...
        <p @click="changeDefault(addres,address)">
          ...
          <span class="s3" v-show="addres.selected==1">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
...
export default {
  ...
  computed: {
    ...mapState('trade', ['orderInfo', 'address', 'payId']),
    //将来提交订单最终选中地址
    userDefaultAddress () {
      //find:查找数组当中符合条件的元素返回，最终返回结果
